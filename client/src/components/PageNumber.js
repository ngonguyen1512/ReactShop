...
const notActive = 'w-[46px] h-[42px] flex justify-center items-center border border-[#000] text-black bg-white mb-4 hover:bg-[#838383] hover:border-[#838383] hover:text-white rounded-lg font-semibold cusor-pointer text-lg'
